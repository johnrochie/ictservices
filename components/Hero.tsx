  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-[#0f0f0f] overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute bottom-20 left-20 w-72 h-72 bg-teal-500 rounded-full blur-3xl"
      />
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 text-center z-10">
        ...
        >
          ...
          <motion.p
            ...
            className="text-xl sm:text-2xl text-[#ccd6f6] max-w-3xl mx-auto mb-12 leading-relaxed"
          >
