        ...
        <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-[#8892b0]">+353 1 XXX XXXX</p>
                    <p className="text-[#8892b0]">+353 1 XXX XXXX</p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-[#8892b0]">info@ictservices.ie</p>
                    <p className="text-[#8892b0]">support@ictservices.ie</p>
                  </div>
                </motion.div>
            ...
            >
              ...
              <div className="space-y-2 text-[#8892b0]">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-white">Mon-Fri, 9am-5pm</span>
                </div>
                <div className="flex justify-between">
          ...
          >
            ...
            <form className="space-y-6">
              <div>
                <label htmlFor="name" className="block text-sm font-semibold text-[#8892b0] mb-2">
                  Name *
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="email" className="block text-sm font-semibold text-[#8892b0] mb-2">
                  Email *
                </label>
                <input
                  type="email"
              ...
              <div>
                <label htmlFor="phone" className="block text-sm font-semibold text-[#8892b0] mb-2">
                  Phone
                </label>
                <input
                  type="tel"
              ...
              <div>
                <label htmlFor="message" className="block text-sm font-semibold text-[#8892b0] mb-2">
                  Message *
                </label>
                <textarea
                  id="message"
